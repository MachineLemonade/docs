...
| -------------- | ---------- | ---------------------------- | ------------------------- |
| P1 | Critical production issue that severely impacts your use of the service. The situation halts your business operations and no procedural workaround exists.<ul><li>Service is down or unavailable.</li><li>Data corrupted or lost and must restore from backup.</li><li>A critical documented feature / function is not available.</li></ul> Severity 1 issues require the customer to have dedicated resources available to work on the issue on an ongoing basis with Astronomer. | Within 60 minutes | Astronomer will: (i) assign specialists to correct the Issue; (ii) provide ongoing communication on the status of an Update or Issue resolution; and (iii) simultaneously begin work to provide a temporary workaround or fix. |
| P2 | Major functionality is impacted or significant performance degradation is experienced. The situation is causing a high impact to portions of your business operations and no reasonable workaround exists.<br /><br />Service is operational but highly degraded performance to the point of major impact on usage.<br /> <br />Important features of the Software as a Service offering are unavailable with no acceptable workaround; however, operations can continue in a restricted fashion. | Within 4 hours | Astronomer will: (i) assign specialists to correct the Issue; (ii) provide ongoing communication on the status of an Update or Issue resolution; and (iii) simultaneously begin work to provide a temporary workaround or fix. |
