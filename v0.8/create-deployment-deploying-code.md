...
To create a deployment on Astronomer, log into the Astronomer UI, whether on [Astronomer Cloud](https://app.astronomer.cloud/login) or your own domain on Astronomer Enterprise (`app.BASEDOMAIN`).
