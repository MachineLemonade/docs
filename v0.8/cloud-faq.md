...
Your first 30 days on Astronomer Cloud are entirely free of cost. When you sign up, you'll trigger a 30-day trial period that allows you to freely spin up a deployment without worrying about an invoice at the end of the month.

After your first 30 days, we'll charge you based on exact resource usage per deployment at the end of the month. You can expect your first invoice on Day 60.
