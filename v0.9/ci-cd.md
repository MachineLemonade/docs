...
With Astronomer's support for Service accounts, you're able to deploy to an Airflow deployment on Astronomer via a Continuous Integration/Continuous Delivery (CI/CD) tool of your choice.
